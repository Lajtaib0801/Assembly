...
main:
    ...
    lea     rax, [wNum]     ;load address of wvar in rax
    mov     rax, [wNum]     ;load address of wNum in rax
    lea     rax, [text1]    ;load content of wNum in rax
    mov     rax, text1      ;load address of text1 in rax
    mov     rax, text1+1    ;load address of text1 in rax
    lea     rax, [text1+1]  ;load second character in rax
    mov     rax, [text1]    ;load second character in rax
